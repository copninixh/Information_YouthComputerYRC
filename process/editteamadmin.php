<?php
    ...
    if($_POST['t_id'] == ''){
        header("location:../editprofileforadmin.php?status=notfoundid");
    }
    ...
    if($result){
        header("location:../editprofileforadmin.php?status=successedit");
    }else{
        header("location:../editprofileforadmin.php?status=erroredit");
    }
