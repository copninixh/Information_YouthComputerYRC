...
<body class="">
	...
	<div id="page-container" class="fade page-sidebar-fixed page-header-fixed page-with-wide-sidebar">
        ...
        <a href="addactivityformadmin.php" class="btn btn-pink">เพิ่มผลงาน</a>
                        ...
                        while($row = mysqli_fetch_array($result)){
							...
							while($fetch2 = mysqli_fetch_array($query)){
								...
								if($fetch2['p_file'] == ''){
										...
										echo"<a href=process/deletepicadmin.php?id=$fetch2[0] class='btn btn-danger'>ลบหลักฐาน</a><br><br>";
							...
							echo"<td><a href=editactivityadmin.php?id=$row[0] class='btn btn-pink'>แก้ไขผลงาน</a> ";
                            echo"<td><a onClick=\"javascript: return confirm('ต้องการลบ ($row[p_name]) ใช่หรือไม่? ไม่สามารถกู้คืนได้ภายหลัง! ');\" href=process/deleteactivityadmin.php?id=$row[0] class='btn btn-danger'>ลบผลงาน</a> ";
							echo'</tr>';
						}
						echo'</tbody>';
						echo'</table>';
